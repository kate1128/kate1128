...
<details class="lake-collapse"><summary id="u0188eb25"><span class="ne-text">output：</span></summary><pre data-language="json" id="fgjwc" class="ne-codeblock language-json"><code>请回答问题：你是谁</code></pre></details>
3. 不使用分隔符
...
<details class="lake-collapse"><summary id="u7d1cac4d"><span class="ne-text">output：</span></summary><pre data-language="json" id="Kbswr" class="ne-codeblock language-json"><code>我是一个智能助手。</code></pre></details>
### 寻求结构化的输出
...
<details class="lake-collapse"><summary id="ue9e9839a"><span class="ne-text">output：</span></summary><pre data-language="json" id="ayPCA" class="ne-codeblock language-json"><code>Text 1 的总结:
第一步 - 把水烧开。
第二步 - 拿一个杯子并把茶包放进去。
第三步 - 把烧开的水倒在茶包上。
第四步 - 等待一会儿，让茶叶浸泡。
...
第七步 - 尽情享受一杯美味的茶。</code></pre></details>
...
<details class="lake-collapse"><summary id="ubafb561a"><span class="ne-text">output：</span></summary><pre data-language="json" id="gUlIs" class="ne-codeblock language-json"><code>Text 2 的总结:
未提供步骤。</code></pre></details>
### 提供少量示例
...
<details class="lake-collapse"><summary id="ub7f5373c"><span class="ne-text">output：</span></summary><pre data-language="json" id="P7Aii" class="ne-codeblock language-json"><code>&lt;圣贤&gt;: 孝顺者，孝敬父母，顺从长辈，尊重家族传统，忠诚孝道，不忘家国情怀。</code></pre></details>
...
<details class="lake-collapse"><summary id="ub0b107c4"><span class="ne-text">output：</span></summary><pre data-language="json" id="qvWRE" class="ne-codeblock language-json"><code>response :
...
<details class="lake-collapse"><summary id="u2937ba87"><span class="ne-text">output：</span></summary><pre data-language="json" id="s3jAM" class="ne-codeblock language-json"><code>学生的解决方案是正确的。首年运营的总费用为450x+100,000美元，其中x为发电站的大小，单位为平方英尺。</code></pre></details>
...
<details class="lake-collapse"><summary id="ue735fbea"><span class="ne-text">output：</span></summary><pre data-language="json" id="Ls0LJ" class="ne-codeblock language-json"><code>1. 论文标题： &quot;Extrapolating LLM Lengths: A Study on the Impact of Training Data Size&quot;
...
希望以上论文能够帮助到您的研究工作。</code></pre></details>
